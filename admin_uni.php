...
.active {
  background-color: #4CAF50;
    ...
    <body>
      ...
      <div class="type-1">
        <div>
          <a href="admin_form_uni.php" class="btn btn-1">
            <span class="txt">ADD UNIVERSITY</span>
        ...
        <div>
          <a href="del_form_uni.php" class="btn btn-2">
      
            <span class="txt">DELETE UNIVERSITY</span>
            <span class="round"><i class="fa fa-chevron-right"></i></span>
          </a>
        </div>
